...
local bypassACOptions = {"EagleAC", "Anvil", "ReaperV4", "WaveShield"}
...
local currentMenuTheme = "Kaneki"
local menuThemes = {
    Gojo = {
        banner = "https://i.imgur.com/bJR2OEx.png",
        color = {0.55, 0.25, 0.7} 
    },
    Kirua = {
    ...
    Kaneki = {
        banner = "https://i.imgur.com/ygt0Agc.gif",
        color = {0.55, 0.0, 0.0} 
    }
}
...
local actions = {
    ...
    menutheme = function()
        local themeNames = {"Gojo", "Kirua", "Zoro", "Vegeto", "Sukuna", "Kaneki"}
